                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    ...
                                    {{Form::model($data,['route' => ['pictureinventarisasi.update', $data->id], 'method' => 'patch', 'class' => 'form form-horizontal','files' => true])}}
                                            <div class="form-body">
                                                ...
                                                <div class="col-md-9 mx-auto">
                                                    ...
                                                    <input type="file" name="picture" placeholder="Choose image" id="picture">
                                                    @if($data->image == null)
                                                    ...
                                                    @else
                                                    <img id="preview-image-before-upload" src="{{asset('img_upload/')}}/{{$data->image}}" alt="preview image" style="max-height: 250px; max-width: 400px;">
                                                    @endif
                                                </div>
                                                </div>
